            ...
            <div className="container-fluid bg-dark text-secondary mt-5 pt-5">
                <div className="row px-xl-5 pt-5">
                    <div className="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                        ...
                        <p className="mb-4">No dolore ipsum accusam no lorem. Invidunt sed clita kasd clita et et dolor
                        ...
                        <div className="row">
                            <div className="col-md-4 mb-5">
                                ...
                                <div className="d-flex flex-column justify-content-start">
                                    ...
                                    <a className="text-secondary" href="#"><i className="fa fa-angle-right mr-2"></i>Contact
                                        Us</a>
                                </div>
                            </div>
                            <div className="col-md-4 mb-5">
                            ...
                            <div className="col-md-4 mb-5">
                                ...
                                <div className="d-flex">
                                    <a className="btn btn-primary btn-square mr-2" href="#"><i
